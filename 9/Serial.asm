...
;	SerialEventHandler:	Handle interrupt appropriately, enqueue the error type and 
...
; local include files
$INCLUDE(Serial.INC)        ;contains definitions and addresses for serial I/O routines
$INCLUDE(Queues.INC)        ;contains definitions and structure for queue functions
...
KickStartInit:                              ;initialize the KickStart variable
        MOV     KickStart, KICKSTART_OFF    ;kickstart is not necessarily required,
...
DataReceived:
        MOV     AH, DATA_EVENT_TYPE         ;set the appropriate event type for
                                            ;   this interrupt
...
CallEnqueueEvent:                           ;otherwise, call the appropriate 
        ...
        MOV     AH, ERROR_EVENT_TYPE        ;set the appropriate event type for
                                            ;   this interrupt
