...
;			   	 value into a string whcih is stored at the memory location indicated
...
;     12/03/16   Dong Hyun Kim    added new include file



;local include files
$INCLUDE(Converts.INC)					;include definitions for conversion routines
