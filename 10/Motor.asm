...
;   GetTurretAngle:		Get the absolute angle setting for the turret.
;	SetTurretElevation: Set the elevation angle for the turret.
;	GetTurretElevation: Get the elevation angle for the turret.  
;
...
; These are five stub functions that do not perform any particular operation, but
; allow the paring operation to happen correctly.

; SetRelTurretAngle
SetRelTurretAngle   PROC		NEAR
                    PUBLIC 		SetRelTurretAngle
                    
		;this is stub function that allows parsing to happen correctly
        RET
